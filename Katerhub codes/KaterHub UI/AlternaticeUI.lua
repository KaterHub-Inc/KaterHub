...
do
    function Library.new(info)
        ...
        local function makeLibrary()
            -- Generated using RoadToGlory's Converter v1.1 (RoadToGlory#9879)
            local Converted = {
                ["omnilocuaHub"] = Instance.new("ScreenGui");
            ...
            Converted["omnilocuaHub"].DisplayOrder = 99
            Converted["omnilocuaHub"].IgnoreGuiInset = true
            Converted["omnilocuaHub"].ResetOnSpawn = false
            Converted["omnilocuaHub"].ZIndexBehavior = Enum.ZIndexBehavior.Sibling
            Converted["omnilocuaHub"].Name = "omnilocuaHub"
            Converted["omnilocuaHub"].Parent = game:GetService("CoreGui")

            Converted["_UI_Library"].Name = "UI_Library"
            Converted["_UI_Library"].Parent = Converted["omnilocuaHub"]

            Converted["_Name"].Value = "omnilocuaHub UI Library"
            Converted["_Name"].Name = "Name"
            Converted["_Name"].Parent = Converted["_UI_Library"]

            Converted["_Creator"].Value = "cqWlWmwGpYyOb2VnowB9"
            ...
            Converted["_Main"].Name = "Main"
            Converted["_Main"].Parent = Converted["omnilocuaHub"]
            ...
            Converted["_Title"].Text = "omnilocuaHub"
            ...
            Converted["_B"].Text = "omnilocuaHub UI Lib: cqWlWmwGpYyOb2VnowB9" -- please don't remove this, this is open sourced and I leave this here so that users can know the name of the UI library if they are interested in it
            ...
            Converted["_A"].Text = "AWP: cqWlWmwGpYyOb2VnowB9"
            ...
            Converted["_Notifications"].Parent = Converted["omnilocuaHub"]
            ...
            Converted["_Hint"].Name = "Hint"
            Converted["_Hint"].Parent = Converted["omnilocuaHub"]
...
print("cqWlWmwGpYyOb2VnowB9 UI Library v"..VERSION.." by omnilocua has initiated")
