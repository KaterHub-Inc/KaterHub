local KaterHubLib = {}
KaterHubLib.Flags = {}
KaterHubLib.DefaultColor = Color3.fromRGB(142, 2, 235)
...
for _,v in pairs(game:GetService("CoreGui"):GetChildren()) do
    if v.Name == "KaterHub" then
        v:Destroy()
    end
end

function KaterHubLib:GetXY(GuiObject)
	local Max, May = GuiObject.AbsoluteSize.X, GuiObject.AbsoluteSize.Y
	local Px, Py = math.clamp(Mouse.X - GuiObject.AbsolutePosition.X, 0, Max), math.clamp(Mouse.Y - GuiObject.AbsolutePosition.Y, 0, May)
	return Px/Max, Py/May
end

function KaterHubLib:Toggle()
    for _,v in pairs(game:GetService("CoreGui"):GetChildren()) do
        if v.Name == "KaterHub" then
...
function KaterHubLib:Notification(NotificationInfo)
...
NotificationInfo.Color = NotificationInfo.Color or KaterHubLib.DefaultColor
...
if not isfolder("KaterHub") then
	...
	writefile("KaterHub/Circle.png", Circle.Body)
	KaterHubLib:Notification({
        Text = "Downloaded KaterHub Msg Lib.",
        Duration = 5
    })
end

function KaterHubLib:Window(Info)
Info.Text = Info.Text or "KaterHub"
...
KaterHub.Name = "KaterHub"
KaterHub.Parent = game:GetService("CoreGui")

local WindowOpened = Instance.new("BoolValue", KaterHub)
...
KaterHubLib.Flags[Info.Flag] = Info.Default
...
innerFrame.Name = "InnerFrame"
innerFrame.Image = getcustomasset("KaterHub/Circle.png")
...
outerFrame.BackgroundColor3 = Info.Default and KaterHubLib.DefaultColor or Color3.fromRGB(62, 62, 62)
...
KaterHubLib.Flags[Info.Flag] = ToggleInfo.Bool
...
pcall(Info.Callback, ToggleInfo.Bool)
    ...
    TweenService:Create(outerFrame, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.InOut),{BackgroundColor3 = ToggleInfo.Bool and KaterHubLib.DefaultColor or Color3.fromRGB(62, 62, 62)}):Play()
end

toggleTextButton.MouseButton1Click:Connect(function()
    Toggled = not Toggled
    KaterHubLib.Flags[Info.Flag] = Toggled
    ...
    TweenService:Create(outerFrame, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.InOut),{BackgroundColor3 = Toggled and KaterHubLib.DefaultColor or Color3.fromRGB(62, 62, 62)}):Play()
end)
...
innerSlider.BackgroundColor3 = KaterHubLib.DefaultColor
...
dragSliderButton.MouseButton1Down:Connect(function() -- Skidded from material ui hehe, sorry
	...
	MouseMove = Mouse.Move:Connect(function()
		local Px = KaterHubLib:GetXY(outerSlider)
